...
public class PrintTicket1 extends JFrame {
    public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime) {
        ...
        JLabel LDeveloper1 = new JLabel("<html><I><font color=\"#8FBC8F\">Developer Name 1</font></I></html>");
        JLabel LDeveloper2 = new JLabel("<html><I><font color=\"#8FBC8F\">Developer Name 2</font></I></html>");
        JLabel LDeveloper3 = new JLabel("<html><I><font color=\"#8FBC8F\">Developer Name 3</font></I></html>");
        JLabel LDeveloper4 = new JLabel("<html><I><font color=\"#8FBC8F\">Developer Name 4</font></I></html>");
        ...
        LDeveloper1.setBounds(285, 485, 300, 20);
        LDeveloper2.setBounds(285, 505, 300, 20);
        LDeveloper3.setBounds(285, 525, 300, 20);
        LDeveloper4.setBounds(285, 545, 300, 20);
        ...
        Panel2.add(LEmpty);
        Panel2.add(LDemo);
        Panel2.add(LDeveloper1);
        Panel2.add(LDeveloper2);
        Panel2.add(LDeveloper3);
        Panel2.add(LDeveloper4);
    ...
    public static void main(String[] args) {
        new PrintTicket("Chennai", "Delhi", "Economy", 2, 1, 0, "2025-05-10", 8500, "14:30");
    }
}
